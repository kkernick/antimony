...
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "run" -d 'Run a profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "create" -d 'Create a new profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "edit" -d 'Edit an existing profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "default" -d 'Edit the default profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "feature" -d 'Modify the system features'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "refresh" -d 'Refresh caches'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "integrate" -d 'Integrate a profile into the user environment'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "reset" -d 'Reset a profile back to the system-defined profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "trace" -d 'Trace a profile for missing syscalls or files'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "info" -d 'List installed profiles and features'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "seccomp" -d 'Perform operations on the SECCOMP Database'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "export" -d 'Export user profiles'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "import" -d 'Import user profiles'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "config" -d 'Import user profiles'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run create edit default feature refresh integrate reset trace info seccomp export import config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
