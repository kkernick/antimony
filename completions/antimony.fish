...
complete -c antimony -n "__fish_antimony_needs_command" -f -a "backend" -d 'Manage the Backend Datastore'
...
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "run" -d 'Run a profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "edit" -d 'Edit an existing profile'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "refresh" -d 'Refresh caches'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "integrate" -d 'Integrate a profile into the user environment'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "remove" -d 'Remove features/profiles, or reset user definitions to the default'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "seccomp" -d 'Perform operations on the SECCOMP Database'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "export" -d 'Export user profiles'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "import" -d 'Import user profiles'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "backend" -d 'Manage the Backend Datastore'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "info" -d 'Get information about profiles/features'
complete -c antimony -n "__fish_antimony_using_subcommand help; and not __fish_seen_subcommand_from run edit refresh integrate remove seccomp export import backend info help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
